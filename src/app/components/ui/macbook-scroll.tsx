...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh] flex flex-col items-center py-0 md:py-[15vh] sm:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.6] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        >
          <span className="text-white filter invert relative h-10 w-20 ">
